...
mod tests {
    ...
    #[test]
    fn full_threats_total_feature_count_matches_cpp() {
        assert_eq!(
            threat_feature_calc().total_features,
            FULL_THREATS_INPUTS as i32
        );
    }
